<Guide description="A comprehensive guide to software engineering best practices, covering architecture, debugging, development processes, code quality, collaboration, security, and reliability. When these best practices are applied to the SmartInfo project for planning, code modification, or Memory Bank management, the 'SmartInfo Project Development Workflow (Memory Bank System)' detailed within the main SYSTEM Prompt MUST be followed.">

# Comprehensive Software Engineering Best Practices

**Important Note for SmartInfo Project Application:**
This guide outlines general software engineering best practices. When these principles are being applied to make changes, plan new features, or manage documentation specifically for the **SmartInfo project**, you **MUST** adhere to the detailed operational workflows, planning procedures, Memory Bank update protocols, and Git synchronization steps defined within your main System Prompt under the heading **"SmartInfo Project Development Workflow (Memory Bank System)"**. That workflow takes precedence for project-specific execution and documentation.

*(For instance, while this guide discusses general documentation and ADRs, the specific format, storage, and update process for plans and decisions in the SmartInfo project are governed by the "SmartInfo Project Development Workflow (Memory Bank System)".)*
...
**Documentation**: Maintain appropriate documentation at all levels, from code comments to architecture diagrams. Focus on keeping documentation concise, accurate, and useful. **For the SmartInfo project, all significant planning, architectural decisions, and progress tracking MUST be documented following the "SmartInfo Project Development Workflow (Memory Bank System)" (detailed in your SYSTEM Prompt), including the use of versioned plan files and core Memory Bank documents.**
...
**Architecture Decision Records (ADRs)**: Document significant technical decisions, including the context, options considered, and rationale. **For the SmartInfo project, ADRs are managed as simplified records within the Memory Bank, following the process outlined in the "SmartInfo Project Development Workflow (Memory Bank System)" (detailed in your System Prompt).**
...
### 8.1 Building High-Performance Web Applications
